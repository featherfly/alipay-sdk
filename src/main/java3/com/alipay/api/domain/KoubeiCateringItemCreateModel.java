...
public class KoubeiCateringItemCreateModel extends AlipayObject {
	...
	private static final long serialVersionUID = 4661597523996711451L;
...
说明：商品的生效时间不能早于创建当天的0点
	 ...
	 */
	@ApiListField("latest_notice")
	@ApiField("string")
	private List<String> latestNotice;
	...
	public List<String> getLatestNotice() {
		return this.latestNotice;
	}
	public void setLatestNotice(List<String> latestNotice) {
